...
- **位移效果**：突进 / 后跳 / 击退 / 吸引
- **实体战斗反馈**：受伤小怪显示头顶血条，按玩家距离最多显示最近 24 个，主 Boss 头顶常驻血条与咏唱进度；玩家与敌人血条分别采用绿色和红色，保留连续受伤的暗色残条（停伤 1 秒或连续 10 秒后收拢），治疗快速高亮，附带边缘闪光和轻微震动；伤害数字在世界空间跟随实体，橙色输出、红色受伤、绿色治疗，暴击附带 `!`
